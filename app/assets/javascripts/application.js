  ...
  function history(){
    $.ajax({
      ...
      success:function(data){
        ...
        data.data.forEach(function(el,index){
          $('table').append("<tr class='danger'> <td>"+el.vehicle.description+"</td><td>"+el.local_start.street+el.local_start.city+el.local_start.state+el.local_start.zip_code+"</td><td>"+el.local_end.street+el.local_end.city+el.local_end.state+el.local_end.zip_code+
